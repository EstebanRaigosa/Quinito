-- 0028_seed_tercer_lugar_asignacion.sql
--
-- Datos de configuración FIFA (Annex C del reglamento del Mundial 2026): las
-- 495 combinaciones C(12,8) de qué grupos aportan los 8 mejores terceros y a
-- qué slot del bracket de dieciseisavos va el tercero de cada grupo.
--
-- `combinacion_grupos` = las 8 letras de grupo clasificadas, ordenadas
-- alfabéticamente (ej. 'ABCDEFGH'). Cada slot_<n> guarda la LETRA del grupo
-- cuyo tercero ocupa el visitante del partido n (74,77,79,80,81,82,85,87).
--
-- Fuente: Wikipedia "2026 FIFA World Cup knockout stage" (Annex C), verificado:
--   495 filas, 495 combinaciones únicas, cada asignación respeta los grupos
--   permitidos por slot (74:ABCDF, 77:CDFGH, 79:CEFHI, 80:EHIJK, 81:BEFIJ,
--   82:AEHIJ, 85:EFGIJ, 87:DEIJL).
-- Generado automáticamente; no editar a mano.

insert into public."tblTercerLugarAsignacion"
  (combinacion_grupos, slot_74, slot_77, slot_79, slot_80, slot_81, slot_82, slot_85, slot_87)
values
...
on conflict (combinacion_grupos) do nothing;
