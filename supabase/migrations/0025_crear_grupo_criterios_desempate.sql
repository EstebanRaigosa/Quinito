-- 0025_crear_grupo_criterios_desempate.sql
--
-- `crear_grupo` insertaba columnas explícitas de reglas sin `criterios_desempate`,
-- así que toda polla nueva quedaba con el default aunque el wizard enviara otro
-- orden. Recreamos el RPC para leer `criterios_desempate` (array de texto) del
-- jsonb de reglas; si no viene o no es array, cae al default. La validez de los
-- valores la garantiza el check de la columna (ver 0024).
